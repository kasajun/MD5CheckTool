...
.type	__KeccakF1600_avx2,@function
.align	32
__KeccakF1600_avx2:
...
.Loop_avx2:
	...
	ret
.size	__KeccakF1600_avx2,.-__KeccakF1600_avx2
.globl	SHA3_absorb_avx2
.type	SHA3_absorb_avx2,@function
.align	32
SHA3_absorb_avx2:
	mov	%rsp,%r11
...
.Ldone_absorb_avx2:
	...
	ret
.size	SHA3_absorb_avx2,.-SHA3_absorb_avx2

.globl	SHA3_squeeze_avx2
.type	SHA3_squeeze_avx2,@function
.align	32
SHA3_squeeze_avx2:
	mov	%rsp,%r11
...
.Ldone_squeeze_avx2:
	...
	lea	(%r11),%rsp
	ret
.size	SHA3_squeeze_avx2,.-SHA3_squeeze_avx2
