...
#define HASH_UPDATE				SHA1_NOASM_Update
#define HASH_TRANSFORM			SHA1_NOASM_Transform
#define HASH_FINAL				SHA1_NOASM_Final
...
#define HASH_BLOCK_DATA_ORDER			sha1_noasm_block_data_order
...
static void HASH_BLOCK_DATA_ORDER(SHA_CTX* c, const void* p, size_t num)
{
	...
	for (;;)
	{
		...
		c->h0 = (c->h0 + A) & 0xffffffff;
		c->h1 = (c->h1 + B) & 0xffffffff;
		c->h2 = (c->h2 + C) & 0xffffffff;
		c->h3 = (c->h3 + D) & 0xffffffff;
		c->h4 = (c->h4 + E) & 0xffffffff;
